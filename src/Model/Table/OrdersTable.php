...
class OrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('sei_name', 'create')
            ->notEmpty('sei_name');

        $validator
            ->requirePresence('mei_name', 'create')
            ->notEmpty('mei_name');
        ...
        $validator
            ->requirePresence('mei_kana', 'create')
            ->notEmpty('mei_kana');

        $validator
            ->requirePresence('mail_no', 'create')
            ->notEmpty('mail_no');

        $validator
            ->requirePresence('mail_add', 'create')
            ->notEmpty('mail_add');
