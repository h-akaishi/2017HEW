        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= $user->sei_name.$user->mei_name ?>さん</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo $this->Url->build(['controller'=>'Users', 'action'=>'mypage',$countId]); ?>" class="btn btn-default btn-flat">マイページ</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?= $user->sei_name.$user->mei_name ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php if($this->request->params['controller'] == 'Earnings'){ echo 'active'; } ?>">
          <a href="#"><i class="fa fa-shopping-cart"></i> <span>注文管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build(['controller'=>'Earnings', 'action'=>'orderHistory']); ?>"><i class="fa fa-circle-o"></i>注文履歴</a></li>
          </ul>
        </li>
        <li class="treeview <?php if($this->request->params['controller'] == 'Users'){ echo 'active'; } ?>">
          <a href="#"><i class="fa fa-users"></i> <span>ユーザ情報</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build(['controller'=>'Users', 'action' => 'mypage', $user->id]); ?>"><i class="fa fa-circle-o"></i>ユーザー情報を表示</a></li>
            <li><a href="<?php echo $this->Url->build(['controller'=>'Users', 'action' => 'edit', $user->id]); ?>"><i class="fa fa-circle-o"></i>ユーザー情報を編集</a></li>
            <li><a href="<?php echo $this->Url->build(['controller'=>'Users', 'action' => 'delete', $user->id]); ?>"><i class="fa fa-circle-o"></i>退会</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
