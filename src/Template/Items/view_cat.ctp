...
<ol class="breadcrumb">
  ...
  <li><a href="<?= $this->Url->build(['controller'=>'Items', 'action'=>'viewCat']) ?>">カテゴリ（キャット）</a></li> 
</ol>
<div class="row">
        <!-- left -->
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="<?= $this->Url->build(['controller'=>'Items', 'action'=>'viewCat']) ?>"><div class="check check-active"></div><span class="op-name">キャット</span></a></li>
