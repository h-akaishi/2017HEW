...
<ol class="breadcrumb">
  ...
  <li><a href="<?= $this->Url->build(['controller'=>'Items', 'action'=>'viewFish']) ?>">カテゴリ（フィッシュ）</a></li> 
</ol>
<div class="row">
        <!-- left -->
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="<?= $this->Url->build(['controller'=>'Items', 'action'=>'viewFish']) ?>"><div class="check check-active"></div><span class="op-name">フィッシュ</span></a></li>
