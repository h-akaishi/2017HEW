...
<ol class="breadcrumb">
  ...
  <li><a href="<?= $this->Url->build(['controller'=>'Items', 'action'=>'viewOther']) ?>">カテゴリ（その他）</a></li> 
</ol>
<div class="row">
        <!-- left -->
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="<?= $this->Url->build(['controller'=>'Items', 'action'=>'viewOther']) ?>"><div class="check check-active"></div><span class="op-name">その他</span></a></li>
                </ul> 
                <!-- </div> -->
            </div>
